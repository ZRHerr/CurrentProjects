...
namespace QuickFix.ViewModels
{
    public class ScheduleViewModel
    {
        public IEnumerable<TimeSlot> ExpandSchedule(Schedule schedule, DateTime startTime, DateTime endTime, ILogger logger = null)
        {
            ...
            if (schedule.ReoccurringSchedules != null)
                outSchedule.AddRange(ExpandRecurringSchedules(schedule.ReoccurringSchedules, startTime, endTime, logger));
        ...
        private IEnumerable<TimeSlot> ExpandRecurringSchedules(
            IList<ReoccuringSchedule> recurringSchedules,
